...
#div001_in01_in01>a:hover{color: red;} 
        ...
        <div id="div001_in01_in01">
            <a href="<%=request.getContextPath() %>/board/mainPage.do">&nbsp; 홈 &nbsp;</a>
				...
				<%
		            ...
		            <a href="<%=request.getContextPath() %>/user/myPage.do?u_id=${admin.AD_ID}">회원정보 &nbsp;</a>
		            ...
		            <%}
		            // 로그인 성공 시,
		            else if(AD_ID.equals("TrillionAdmin1")){%> 
					...
					<a href="<%=request.getContextPath()%>/user/reserveCheck.do">예약조회&nbsp;</a> 
					<a href="<%=request.getContextPath()%>/board/search.do">리스트 &nbsp;</a>
           		    <a style="color: green;"> " ${admin.AD_ID} 님 환영합니다. "</a>
         	   <%}%>
